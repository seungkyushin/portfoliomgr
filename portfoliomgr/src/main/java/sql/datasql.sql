...
INSERT INTO project(name, url, sub_description, description, file_id) VALUES('WEB DBMS','http://localhost:8080/portfoliomgr/main', '웹으로  DATA를 관리 합니다.', 'COMMING SOON',3);
